...
export default () => {
  group('Dia do Trabalhador', function() {
    ...
    let query1 = http.get(`${BASE_URL}/holidays/1600501/2020-05-01/`);
    check(query1, {
    ...
    let query2 = http.get(`${BASE_URL}/holidays/4305439/2020-05-01/`);
    check(query2, {
    ...
    let delr = http.del(`${BASE_URL}/holidays/4305439/05-01/`);
    check(delr, {
  ...
  group('Consciência Negra RJ', function() {
    ...
    let register = http.put(`${BASE_URL}/holidays/33/11-20/`, payload, { headers: HEADERS });
    check(register, {
    ...
    let query1 = http.get(`${BASE_URL}/holidays/33/2020-11-20/`);
    check(query1, {
    ...
    let query2 = http.get(`${BASE_URL}/holidays/3304557/2020-11-20/`);
    check(query2, {
    ...
    // de um município
    let del1 = http.del(`${BASE_URL}/holidays/3304557/11-20/`);
    check(del1, {
    ...
    let del2 = http.del(`${BASE_URL}/holidays/33/11-20/`);
    check(del2, {
  ...
  group('Sexta-Feira Santa', function() {
    let query = http.get(`${BASE_URL}/holidays/2111300/2020-04-10/`);
    check(query, {
  ...
  group('Corpus Christi Ouro Preto', function () {
    ...
    let register = http.put(`${BASE_URL}/holidays/3146107/corpus-christi/`, { headers: HEADERS });
    check(register, {
      'cadastro retorna status 200 ou 201':
      (r) => [200, 201].includes(r.status),
    });
    ...
    let query1 = http.get(`${BASE_URL}/holidays/3146107/2020-06-11/`);
    check(query1, {
    ...
    // Consulta feriado móvel municipal
    let query2 = http.get(`${BASE_URL}/holidays/3146107/2021-06-03/`);
    check(query2, {
      'consulta deve retornar 200': (r) => r.status === 200
    });
    check(query2.json(),
